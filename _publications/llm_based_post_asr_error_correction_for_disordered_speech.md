...
citation: 'Hangyi Wen, Mikiyas Assefa, Anas Semsayan, and Eduardo Feo-Flushing. 2026 (to appear). LLM-Based Post-ASR Error Correction for Disordered Speech. ICASSP 2026 - 2026 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP).'
bibtex: |
  @INPROCEEDINGS{iccasp26,
...
blurb: 'A lightweight LLM post-processing method that corrects ASR errors in disordered speech to improve transcription accuracy and robustness.'
onhomepage: true
---
